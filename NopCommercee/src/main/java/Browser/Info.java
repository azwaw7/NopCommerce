...
public class Info {
    ...
    public static String Zipcode="100001";
    public static String Phonenumber ="311456789";
    public static String CardNumber ="4343101010203101";
    public  static  String CardCode ="123";
